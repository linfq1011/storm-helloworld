...
public class WordCountTopology {
	...
	public static class RandomSentenceSpout extends BaseRichSpout {
		...
		private static final long serialVersionUID = 7362258289600206342L;
		 ...
		 * nextTuple方法
		 *
		 * 这个spout类，之前说过，最终会运行在task中，某个Worker进程的某个excutor线程内部事务某服务task中
		 *
		 * 那个task会负责去不断的无线循环调用nextTuple()方法
		 *
	 ...
	 *
	 * 实现里面的所有方法即可，每个bolt代码，同样是发送到worker某个executor的task里面去运行
	 */
	public static class SplitSentence extends BaseRichBolt {

		private static final long serialVersionUID = 6560190666409699410L;
	...
	public static class  WordCount extends BaseRichBolt {
		...
		private static final long serialVersionUID = 3823847506711589801L;
	...
	public static void main(String[] args) {
		...
		// 这个很重要，相同的单词，从SplitSentence发射出来时，一定会进入到下游的指定的同一个task中
